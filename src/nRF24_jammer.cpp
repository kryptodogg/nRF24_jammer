...
void setup() {
  ...
  // Configure SPI OLED display
  // Note: SPI pins (MOSI, CLK, DC, RESET, CS) are already configured in options.cpp
  // The display object was created with these pins in the constructor
  if(!display.begin(SSD1306_SWITCHCAPVCC)) {
    Serial.println(F("SSD1306 SPI display allocation failed"));
    Serial.println(F("Check wiring: MOSI=13, CLK=14, DC=26, CS=25, RST=27"));
